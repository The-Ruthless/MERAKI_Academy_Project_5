...
const Profile = () => {
  ...
  <br/>
	<br/>
	<img justify="center" width="200" height="200"  src={logo} alt="loading..." />
  <br/>
	<br/>
	<br/>
  ...
  <MenuItem icon={<AccountCircleRoundedIcon color="black"  />}><Link to="/profile" ></Link>My Profile</MenuItem>
  <br/>

  <MenuItem icon={<AddCircleRoundedIcon color="white"  />}><Link to="/profile/myads" ></Link>My Ads</MenuItem>
  <br/>
  

	<MenuItem icon={<FavoriteRoundedIcon color="black"  />}><Link to="/Profile/MyfavoriteAds" ></Link>My Favorites Ads</MenuItem>
  </Menu>
 ...
 <Route exact path="/Profile/MyfavoriteAds" render={() => <MyfavoriteAds />} />
